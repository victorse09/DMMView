"""
DMMView Plugin - OWON XDM1041 / XDM1241
...
class OwonXDM1041Plugin(BaseDMMPlugin):
    @property
    def name(self) -> str:
        return "OWON XDM1041/1241"
    ...
    @property
    def model(self) -> str:
        return "XDM1041/XDM1241"

    @property
    def description(self) -> str:
        return "Conexión SCPI por Puerto Serie para OWON XDM1041/1241."

    @property
    def serial_params(self) -> SerialParams:
        # Standard SCPI over serial is usually 115200 for bench devices
